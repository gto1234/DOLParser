...
// DOLParser.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDOLParserApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CDOLParserApp

CDOLParserApp::CDOLParserApp()
{
...
// Единственный объект CDOLParserApp

CDOLParserApp theApp;


// Инициализация CDOLParserApp

BOOL CDOLParserApp::InitInstance()
{
